                                ...
                                <TableBody>
                                    {components.filter(c => c.is_active).map(c => (
                                        <TableRow key={c.id} className="hover:bg-gray-50/80 dark:hover:bg-gray-800/50 border-gray-50 dark:border-gray-800 transition-colors group">
                                            <TableCell className="px-6 py-4">
                                                <div className="flex items-center gap-3">
                                                    <div className={`w-8 h-8 rounded-lg flex items-center justify-center text-xs font-bold ${c.component_type === 'EARNING' ? 'bg-emerald-50 text-emerald-600' :
                                            ...
                                            <TableCell className="px-6 py-4">
                                                <span className={`inline-flex px-2 py-0.5 rounded text-[9px] font-black uppercase tracking-tight ring-1 ring-black/5 ${c.component_type === 'EARNING' ? 'bg-emerald-50/50 text-emerald-600 dark:bg-emerald-500/10' :
                                                    c.component_type === 'DEDUCTION' ? 'bg-red-50/50 text-red-600 dark:bg-red-500/10' :
                                                        'bg-blue-50/50 text-blue-600 dark:bg-blue-500/10'
                                                    }`}>
                                                ...
                                                <TableCell className="px-8 py-3.5">
                                                    <div className="flex items-center gap-2">
                                                        <div className={`w-1.5 h-1.5 rounded-full ${b.component_type === 'DEDUCTION' ? 'bg-red-400' :
                                                            b.component_type === 'EMPLOYER_CONTRIBUTION' ? 'bg-blue-400' : 'bg-emerald-400'
                                                            }`} />
                                                        <span className={`text-[11px] font-bold uppercase tracking-tight ${b.component_type === 'DEDUCTION' ? 'text-red-500' :
                                                            b.component_type === 'EMPLOYER_CONTRIBUTION' ? 'text-blue-500' : 'text-gray-700 dark:text-gray-200'
                                                            }`}>
                                                            {b.component_name}
                                                        </span>
                                                    </div>
                            ...
                            <div className="p-8 bg-slate-900 dark:bg-gray-950 flex justify-between items-center group">
                                ...
                                <div className="text-right">
                                    ...
                                    <div className="flex items-center justify-end gap-1 mt-1">
                                        ...
                                        <p className="text-[8px] font-black text-emerald-500 uppercase tracking-tighter">Verified Computation</p>
                                    </div>
                                </div>
                            </div>
                        </Card>
