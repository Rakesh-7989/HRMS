        ...
        <div className="space-y-8 animate-fadeIn">
            <Card className="p-0 border-none shadow-elev-1 ring-1 ring-black/5 overflow-hidden">
                <div className="p-8 border-b border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-800/50 flex flex-col md:flex-row md:items-center justify-between gap-6">
                    ...
                    {currentSalary && (
                        <div className="flex items-center gap-3 px-4 py-2 bg-brand-50 dark:bg-brand-500/10 rounded-xl ring-1 ring-purple-500/20">
                ...
                <div className="p-8 bg-gray-50/50 dark:bg-gray-950/20">
                    {!isReadOnly && (
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 items-end">
                            ...
                            <Button
                                className="h-11 bg-brand-500 hover:bg-brand-500/90 text-white font-black text-xs uppercase tracking-[0.15em] rounded-xl shadow-elev-4 shadow-brand-500/20 transition-all active:scale-[0.98]"
                    ...
                    <div className="p-8 bg-white dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800 animate-fadeIn">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8 text-sm">
                            ...
                            <div className="p-5 bg-brand-50/50 dark:bg-brand-500/5 rounded-2xl ring-1 ring-purple-500/10 shadow-elev-1 border border-brand-100/50 dark:border-purple-900/20">
                                <p className="text-[9px] font-bold text-brand-500/50 dark:text-brand-400/50 uppercase tracking-widest mb-1.5">Net Take-Home</p>
                                <p className="text-lg font-black text-brand-600 dark:text-brand-400">{formatCurrency(breakdown.monthly_net)}</p>
                            </div>
                            <div className="p-5 bg-brand-500/5 rounded-2xl ring-1 ring-primary/10 shadow-elev-1 border border-brand-500/5">
                                <p className="text-[9px] font-bold text-brand-500/50 dark:text-brand-500/50 uppercase tracking-widest mb-1.5">Annual Valuation</p>
                                <p className="text-lg font-black text-brand-500">{formatCurrency(breakdown.annual_ctc)}</p>
                            </div>
                        </div>
                        ...
                        {!isReadOnly && (
                            <div className="space-y-6 pt-6 border-t border-gray-100 dark:border-gray-800">
                                <div className="space-y-2">
                                    ...
                                    <div className="relative group/input">
                                        <Input
                                            ...
                                            className="h-11 pl-10 pr-4 font-semibold text-gray-700 dark:text-gray-200 bg-gray-50 dark:bg-gray-950 border-gray-200 dark:border-gray-800 rounded-xl focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 transition-all shadow-elev-1"
                                        />
                                        <div className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within/input:text-brand-500 transition-colors">
                                            <FileText size={16} />
                                        </div>
                                ...
                                <div className="flex justify-end gap-3">
                                    ...
                                    <Button
                                        className="h-11 px-8 bg-slate-900 dark:bg-brand-500 hover:bg-slate-800 dark:hover:bg-brand-500/90 text-white font-black text-xs uppercase tracking-[0.15em] rounded-xl shadow-elev-4 transition-all active:scale-[0.98]"
                ...
                {currentSalary && !breakdown && (
                    <div className="p-8 border-t border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900">
                        <div className="flex items-start gap-5 p-6 bg-brand-50/30 dark:bg-brand-500/5 rounded-3xl ring-1 ring-blue-500/10 border border-brand-100/30 dark:border-violet-900/20">
                            <div className="w-10 h-10 bg-white dark:bg-gray-950 rounded-xl flex items-center justify-center shadow-elev-1 shrink-0">
                                <TrendingUp className="text-brand-600" size={20} />
                            </div>
                            <div className="flex-1">
                                <div className="flex items-center gap-2 mb-4">
                                    <p className="text-[10px] font-black text-brand-800/50 dark:text-brand-400/50 uppercase tracking-[0.2em]">Active Financial Status</p>
                                    <div className="px-2 py-0.5 bg-brand-500 text-white text-[8px] font-black uppercase tracking-tighter rounded">Current Contract</div>
                                </div>
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                                    <div>
                                        <p className="text-[9px] font-bold text-brand-600/50 dark:text-brand-400/40 uppercase tracking-widest mb-1.5">Monthly Liquidity</p>
                                        <p className="text-lg font-black text-brand-800 dark:text-brand-200">{formatCurrency(currentSalary.summary?.monthly_net || 0)}</p>
                                    </div>
                                    <div>
                                        <p className="text-[9px] font-bold text-brand-600/50 dark:text-brand-400/40 uppercase tracking-widest mb-1.5">Gross Valuation (Annual)</p>
                                        <p className="text-lg font-black text-brand-800 dark:text-brand-200">{formatCurrency(currentSalary.annual_ctc)}</p>
                                    </div>
                                    <div>
                                        <p className="text-[9px] font-bold text-brand-600/50 dark:text-brand-400/40 uppercase tracking-widest mb-1.5">Effective Timeline</p>
                                        <p className="text-sm font-black text-brand-800 dark:text-brand-200 uppercase tracking-widest">{format(new Date(currentSalary.effective_from), 'MMM dd, yyyy')}</p>
                                    </div>
                                    <div className="flex items-center gap-2 text-[8px] font-black text-brand-600/50 dark:text-brand-400/30 uppercase tracking-[0.2em] self-end">
